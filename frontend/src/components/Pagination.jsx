...
function Pagination({
  ...
  return (
    <>
      <div className="pagination flex items-center justify-end right-0 bg-white px-5 pt-2 pb-2 md:pb-0 w-full md:mb-0 fixed md:sticky bottom-[76px] md:bottom-0 z-10">
